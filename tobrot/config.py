...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1505807892:AAHPu6miPDVtPGOHWFF4NL3BBplUt1244eE")
    ...
    FREE_USER_MAX_FILE_SIZE = 5000000
    ...
    TELEGRAM_LEECH_COMMAND_G = os.environ.get("TELEGRAM_LEECH_COMMAND_G", "tleechnot")
